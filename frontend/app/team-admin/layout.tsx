...
const navigation = [
    { name: 'Knowledge Base', href: '/team-admin', icon: BookOpen },
    { name: 'Analytics', href: '/team-admin/analytics', icon: BarChart3 },
    { name: 'Team Members', href: '/team-admin/users', icon: Users },
    { name: 'Settings', href: '/team-admin/settings', icon: Settings },
];
                ...
                >
                    <div className="flex flex-col h-full">
                        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-gray-700">
                            <h1 className="text-xl font-bold text-gray-900 dark:text-white">Team Admin</h1>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 dark:text-gray-400">Team Admin</p>
                                    </div>
                                </div>
